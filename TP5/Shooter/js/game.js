...
///////////////////////////////////
//une collection de fonction de mouvement

var f1X=function(x,y){
  let x1=x-2;
  return x1;
}

var f1Y=function(x,y){
  let y1= y+ArenaHeight/3 * Math.sin(x/100);
  return y1;
}
var f2X=function(x,y){
  let x1=x-5;
  return x1;
}

var f2Y=function(x,y){
  let y1=(Math.random()*y)%10;
  return y1;
}
...
//test
function Enemy(x,y,speed,trajectoireX,trajectoireY){
    this.x = x;
    this.yOrigine = y;
    ...
    this.update = function(){
       if(this.cptExplosion==0){//is not exploding
            this.x =  trajectoireX(this.x,this.yOrigine) ;
            this.y =  trajectoireY(this.x,this.yOrigine);
                ...
                explodes : function(){
                    if(this.timeToBeAlive == 0) {
                        ...
                        if(this.nbOfLives>0){
                            ...
                            conArena.fillStyle="yellow";
                            conArena.fillRect(0,0,ArenaWidth,ArenaHeight);
     ...
     if(tics % 100 == 1) {
         ...
         switch (alea) {
           case 0: enemies.add(new Enemy(ArenaWidth, rand,-2,f1X,f1Y));
             break;
             case 1: enemies.add(new Enemy(ArenaWidth, rand,-2,f2X,f2Y));
           default:
